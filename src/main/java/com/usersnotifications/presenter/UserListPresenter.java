...
public class UserListPresenter {
  ...
  private void screenConfiguration() {
    ...
    view.getVisualizationBtn().setEnabled(false);

    view.getUserTbl().addMouseListener(new MouseAdapter() {
      @Override
      public void mouseClicked(java.awt.event.MouseEvent evt) {
        if (view.getUserTbl().getSelectedRow() > -1) {
          view.getVisualizationBtn().setEnabled(true);
        }
      }
    });
  ...
  public UserListViewVelha getView() {
    return view;
  }
